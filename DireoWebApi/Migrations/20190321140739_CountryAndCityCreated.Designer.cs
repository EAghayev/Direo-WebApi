...
namespace DireoWebApi.Migrations
{
    ...
    [Migration("20190321140739_CountryAndCityCreated")]
    partial class CountryAndCityCreated
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DireoWebApi.Models.City", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36);
            ...
            modelBuilder.Entity("DireoWebApi.Models.Country", b =>
                {
                    b.Property<string>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36);
            ...
            modelBuilder.Entity("DireoWebApi.Models.City", b =>
                {
                    b.HasOne("DireoWebApi.Models.Country", "Country")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("DireoWebApi.Models.Place", b =>
                {
                    ...
                    b.HasOne("DireoWebApi.Models.City", "City")
                        .WithMany("Places")
